        ...
        <SidebarProvider>
                    ...
                    <section className="catalog-panel" id="catalog">
                        ...
                        {loading ? (
                            ...
                            <div className="empty">
                                ...
                                <p>Create your first product to start managing your catalog.</p>
                            ...
                            <ProductTable
                                products={filtered}
                                edit={setEditing}
                                archive={async (product) => setArchiving(product)}
                            />
                        ) : (
            ...
            {archiving && (
                <ConfirmDialog
                    ...
                    description="This product will be removed from the active catalog. You can restore it later if supported by your workflow."
                    ...
                    onConfirm={() => {
                        ...
                        void archive(product)
                            .then(() => toast.success("Product archived"))
                            .catch(() =>
